...
router.post('/register', async (req, res) => {
    const { name, email, password, age, gender,isAdmin } = req.body;
    ...
    try {   
        ...
        const user=await createUser(name, email, password, age, gender,isAdmin);
...
router.post('/send-email', (req, res) => {
    ...
    console.log(`to:${email},subject:${subject},message:${message}`)
    ...
    function getTransporter(email) {
        ...
        transporterConfig = {
            ...
            secure: false,
            auth: {
            user: 'Avokebila11@gmail.com',
            pass: 'qqhf dpmx vdbk ygwi'
            }
        };
...
router.patch('/patchUser/:id', async (req, res) => {
    try {
        const { id } = req.params;
        const { name,email,age,gender,isAdmin } = req.body;
        console.log(id ,name,email,age,gender,isAdmin )
        const updated = await updateUser(id, name,email,age,gender,isAdmin);
        console.log(updated)
